...
Recipes.create('pizza', ['chesse','dough','bread','tomatoes']);
Recipes.create('enchiladas', ['tomato sauce','green bell pepper','clove garlic','flour tortilla']);
Recipes.create('tuna salad', ['celery','parsley','mayo','black pepper']);
